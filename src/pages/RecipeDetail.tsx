...
import RecipeUtensils from '../components/recipe/RecipeUtensils';
import RecipeTimer from '../components/recipe/RecipeTimer';
import RecipeNotes from '../components/recipe/RecipeNotes';
import RecipeVariations from '../components/recipe/RecipeVariations';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 flex flex-wrap gap-2">
              {recipe.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-sm font-medium text-orange-500"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            {/* Timer */}
            <RecipeTimer duration={parseInt(recipe.duration)} stepName="Préparation" />
            ...
            {recipe.alternatives && (
              <section className="bg-white rounded-xl shadow-sm p-6">
                <RecipeVariations variations={recipe.alternatives} />
              </section>
            )}
          </div>
        </div>
        ...
        <section className="mt-12">
          <RecipeRecommendations currentRecipe={recipe} recommendations={recipes.slice(0, 3)} />
        </section>
      </div>
