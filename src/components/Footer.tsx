...
export default function Footer() {
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Panier Express', path: '/express-basket' },
        { name: 'Programme fidélité', path: '/loyalty-program' },
  ...
  return (
    <footer className="bg-gradient-to-br from-green-200/60 via-yellow-100/60 to-green-100/60 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-lg font-semibold text-green-900 dark:text-gray-100 mb-6">
                {section.title}
              </h3>
